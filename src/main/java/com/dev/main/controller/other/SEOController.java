...
//        urls.add(new SitemapUrl(BASE_URL + "/en/home/blog", "weekly", "0.8"));
//        urls.add(new SitemapUrl(BASE_URL + "/en/home/newcomers", "daily", "0.9"));
//        urls.add(new SitemapUrl(BASE_URL + "/en/home/about", "yearly", "0.5"));
//        urls.add(new SitemapUrl(BASE_URL + "/en/home/news","weekly","0.6"));
